...
% SWAP THESE FOR PREPRINT AND SUBMISSION
...
% \usepackage{xltabular} % For flexible tabular layouts
...
% \newcommand{\longtitle}{\raisebox{-0.3\height}{\includegraphics[width=2em,height=2em]{assets/axbench-logo.png}} \shortbenchmark: Benchmarking Detection and Steering of\\Natural-Language Concepts at Scale}

% \newcommand{\longtitle}{\raisebox{-0.3\height}{\includegraphics[width=2em,height=2em]{assets/axbench-logo.png}} \shortbenchmark: Does representation steering outperform simple baselines?}
% \newcommand{\longtitle}{\raisebox{-0.3\height}{\includegraphics[width=2em,height=2em]{assets/axbench-logo2.png}} \shortbenchmark: Do representation steering methods outperform prompting and fine-tuning baselines?}
% \newcommand{\longtitle}{\raisebox{-0.3\height}{\includegraphics[width=2em,height=2em]{assets/axbench-logo2.png}} \shortbenchmark: Steering LLMs? Definitely don't use Sparse Auto-Encoders!}
\newcommand{\longtitle}{\raisebox{-0.3\height}{\includegraphics[width=2em,height=2em]{assets/axbench-logo2.png}} \shortbenchmark: Steering LLMs? Even Simple Baselines\\Outperform Sparse Autoencoders}


% \newcommand{\longtitle}{Interpretability Utility for Language Models}
% \newcommand{\longtitle}{Evaluating the Utility of Linear Subspace at Scale}
\newcommand{\shorttitle}{\shortbenchmark}
\newcommand{\longbenchmark}{Abstraction Bench}
\newcommand{\shortbenchmark}{\textsc{AxBench}}
\newcommand{\longmethod}{Representation Abstraction}
\newcommand{\shortmethod}{ReAX}
...
% Define the methodtag macro
\newcommand{\methodtag}[2]{%
  \tikz[baseline=(char.base)]{%
    \node[
      ...
      text=white,
      font=\bfseries,
      % Force the node to be a fixed size
      minimum width=1em,
      minimum height=1em,
      % Keep text centered in the forced-size box
      align=center,
      inner sep=0pt
    ](char){#2};%
  }%
...
\definecolor{conceptcolor}{HTML}{37c1c1}
\definecolor{steeringcolor}{HTML}{156c6c}

\newcommand{\concepttag}{\protect\methodtag{conceptcolor}{C}}
\newcommand{\steeringtag}{\protect\methodtag{steeringcolor}{S}}
...
% \author[1]{Zhengxuan Wu\thanks{Equal contribution}}
% \author[1]{Aryaman Arora$^*$}
% \author[2]{Atticus Geiger}
% \author[1]{Zheng Wang}
% \author[1]{Jing Huang}
% \author[1]{\\Dan Jurafsky}
% \author[1]{Christopher D. Manning}
% \author[1]{Christopher Potts}

% \affil[1]{Stanford University}
% \affil[2]{Pr(AI)\textsuperscript{2}R Group}
...
% \thispagestyle{fancy}
% \fancyhead[L]{\raisebox{-0.2\height}{\includegraphics[width=2cm]{assets/pyvene-logo.png}}}
% \fancyhead[R]{\today}
